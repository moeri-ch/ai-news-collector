...
- [NotebookLM×Claude×draw.ioでkintone営業支援パックの構成図を自動生成してみた - Qiita](https://qiita.com/kanekoh/items/a323409d28a68254484e)
  - こんにちは！かねごん（@hrbk25）です！ この記事では、少し前からSNSで話題になっていた「Claudeを使って、draw.ioのXMLを作ってもらう」という内容を、身近な内容とAIアシスタントツールを使って試してみましたので、その内容を備忘録として残しておきます。 どんな人向けの記事か システ...
...
- [Multimodal agents tutorial: How to use Gemini, Langchain, and LangGraph to build agents for object detection](https://cloud.google.com/blog/products/ai-machine-learning/build-multimodal-agents-using-gemini-langchain-and-langgraph/)
  - Here’s a common scenario when building AI agents that might feel confusing: How can you use the latest Gemini models and an open-source framework like...
- [From analytics to data management: New BigQuery transactional features](https://cloud.google.com/blog/products/data-analytics/bigquery-features-for-transactional-data-management/)
  - For years, BigQuery has been synonymous with fully managed, fast, petabyte-scale analytics. Its columnar architecture and decoupled storage and comput...
- [From data lakes to user applications: How Bigtable works with Apache Iceberg](https://cloud.google.com/blog/products/databases/bigtable-spark-connector-now-ga/)
  - The latest version of the Bigtable Spark connector opens up a world of possibilities for Bigtable and Apache Spark applications, not least of which is...
- [Enhancing Google Cloud protection: 4 new capabilities in Security Command Center](https://cloud.google.com/blog/products/identity-security/enhancing-protection-4-new-security-command-center-capabilities/)
  - In today's cloud environments, security teams need more than just surface-level visibility; they require actionable insight to ensure that their cloud...
- [Announcing new MCP integrations to Google Cloud Databases to enable AI-assisted development](https://cloud.google.com/blog/products/ai-machine-learning/new-mcp-integrations-to-google-cloud-databases/)
  - Last month at Google Cloud Next ‘25, we announced MCP Toolbox for Databases to make it easier to connect generative AI agents to databases, and automa...
- [Hello, Operator? A Technical Analysis of Vishing Threats](https://cloud.google.com/blog/topics/threat-intelligence/technical-analysis-vishing-threats/)
  - Written by: Nick Guttilla

Introduction
Organizations are increasingly relying on diverse digital communication channels for essential business operat...
- [The Cost of a Call: From Voice Phishing to Data Extortion](https://cloud.google.com/blog/topics/threat-intelligence/voice-phishing-data-extortion/)
  - Introduction
Google Threat Intelligence Group (GTIG) is tracking UNC6040, a financially motivated threat cluster that specializes in voice phishing (v...
- [Emulating the air-gapped experience: GDC Sandbox is now generally available](https://cloud.google.com/blog/topics/hybrid-cloud/using-gdc-sandbox-to-emulate-air-gapped-environments/)
  - Many organizations in regulated industries and the public sector that want to start using generative AI face significant challenges in adopting cloud-...
- [How to build a digital twin on Google Cloud](https://cloud.google.com/blog/products/identity-security/how-to-build-a-digital-twin-to-boost-resilience/)
  - “There’s no red teaming on the factory floor,” isn’t an OSHA safety warning, but it should be — and for good reason. Adversarial testing in most, if n...
- [How Alpian is redefining private banking for the digital age with gen AI](https://cloud.google.com/blog/topics/financial-services/how-alpian-is-redefining-private-banking-for-the-digital-age-with-gen-ai/)
  - As the first fully cloud-native private bank in Switzerland, Alpian stands at the forefront of digital innovation in the financial services sector. Wi...
- [Streamline your your AI/ML data transfers with new GKE Volume Populator](https://cloud.google.com/blog/products/containers-kubernetes/gke-volume-populator-streamlines-aiml-data-transfers/)
  - As an AI/ML developer, you have a lot of decisions to make when it comes to choosing your infrastructure — even if you’re running on top of a fully ma...
- [Is your browser a blindspot in your security strategy?](https://cloud.google.com/blog/products/chrome-enterprise/is-your-browser-a-blindspot-in-your-security-strategy/)
...
- [Cloud Run で GPU の一般提供を開始: AI ワークロードの実行が誰にとっても簡単に](https://cloud.google.com/blog/ja/products/serverless/cloud-run-gpus-are-now-generally-available/)
  - ※この投稿は米国時間 2025 年 6 月 3 日に、Google Cloud blog に投稿されたものの抄訳です。
Google Cloud のサーバーレス ランタイムである Cloud Run は、そのシンプルさ、柔軟性、スケーラビリティから、デベロッパーに人気を博しています。このたび、Clo...
- [新機能 GKE Volume Populator で AI / ML データ転送を効率化](https://cloud.google.com/blog/ja/products/containers-kubernetes/gke-volume-populator-streamlines-aiml-data-transfers/)
  - ※この投稿は米国時間 2025 年 6 月 4 日に、Google Cloud blog に投稿されたものの抄訳です。
AI / ML 開発者は、インフラストラクチャを選択する際に多くの決断を下す必要があります。この点は、フルマネージドの Google Kubernetes Engine（GKE）環...
- [AI を活用した通信業界: ネットワーク変革の新時代](https://cloud.google.com/blog/ja/topics/telecommunications/the-ai-driven-telecom-a-new-era-of-network-transformation/)
  - ※この投稿は米国時間 2025 年 5 月 22 日に、Google Cloud blog に投稿されたものの抄訳です。
通信業界は大きな変革を遂げつつありますが、その中で AI と生成 AI が主要な推進力として台頭しています。通信サービス プロバイダ（CSP）は、これらの AI テクノロジーが、...
- [Google Cloud のオープン レイクハウス: AI、オープンデータ、比類のないパフォーマンスを実現する設計](https://cloud.google.com/blog/ja/products/data-analytics/extending-the-google-data-cloud-lakehouse-architecture/)
  - ※この投稿は米国時間 2025 年 5 月 29 日に、Google Cloud blog に投稿されたものの抄訳です。
Google のデータクラウドは、Google のグローバル規模のインフラストラクチャ上に構築された独自の統一プラットフォームで、AI が組み込まれており、マルチモーダル データ...
- [進化した BigLake: オープンで高パフォーマンスなエンタープライズ向け Iceberg ネイティブ レイクハウスを構築する](https://cloud.google.com/blog/ja/products/data-analytics/enhancing-biglake-for-iceberg-lakehouses/)
  - ※この投稿は米国時間 2025 年 5 月 30 日に、Google Cloud blog に投稿されたものの抄訳です。
データ マネジメントは変化を続けています。企業は、複数のエンジンが 1 つのデータコピーで動作できる、柔軟かつオープンで相互運用可能なアーキテクチャを必要としています。Apach...
- [次世代の生成 AI メディアモデルで Vertex AI を強化](https://cloud.google.com/blog/ja/products/ai-machine-learning/announcing-veo-3-imagen-4-and-lyria-2-on-vertex-ai/)
...
Google の画像生成モデルである...
- [AI を使って優れた SQL を作成する: Text-to-SQL 手法の説明](https://cloud.google.com/blog/ja/products/databases/techniques-for-improving-text-to-sql/)
  - ※この投稿は米国時間 2025 年 5 月 17 日に、Google Cloud blog に投稿されたものの抄訳です。
組織が意思決定を行うには、迅速かつ正確でデータドリブンな分析情報が必要です。そのデータにアクセスする方法の中心にあるのが SQL です。Google は、Gemini を使用する...
- [AI を活用してデータベース フリート管理の簡素化を実現するデータベース センターの一般提供を開始](https://cloud.google.com/blog/ja/products/databases/database-center-is-now-generally-available/)
  - ※この投稿は米国時間 2025 年 5 月 16 日に、Google Cloud blog に投稿されたものの抄訳です。
Google Cloud Next 25 で、モニタリング、最適化、セキュリティなど、データベース フリート管理のあらゆる側面を簡素化する、AI を活用した統合フリート管理ソリュ...
- [Google I/O 2025: 任務の成果を推進するイノベーション](https://cloud.google.com/blog/ja/topics/public-sector/google-io-2025-innovation-that-drives-mission-impact/)
  - ※この投稿は米国時間 2025 年 5 月 30 日に、Google Cloud blog に投稿されたものの抄訳です。Google I/O 2025 では、一連の画期的な AI 機能の進化について発表し、場所を問わずあらゆる組織を支援するテクノロジーの新たな境地を切り開きました。イノベーションの新...
- [Compute Engine で Red Hat Enterprise Linux の確約利用割引が利用可能に](https://cloud.google.com/blog/ja/products/compute/get-committed-use-discounts-for-rhel/)
  - ※この投稿は米国時間 2025 年 5 月 30 日に、Google Cloud blog に投稿されたものの抄訳です。
このたび、Google Cloud で Red Hat Enterprise Linux の確約利用割引（CUD）の一般提供が開始されました。Compute Engine で一貫...
- [Google Cloudユーザー会「Jagu'e'r」が Peatix コミュニティアワード 2025 を受賞！](https://cloud.google.com/blog/ja/topics/partners/jaguer-peatix-community-award-2025/)
  - この度、Google Cloudの公式エンタープライズユーザー会である「Jagu'e'r（Japan Google Cloud Usergroup for Enterprise）」が、「Peatix コミュニティアワード2025」において、応募総数 450 のコミュニティの中から、栄えある「テクノロ...
- [Vertex AI Studio の刷新: あらゆるモダリティにわたる生成 AI メディアモデルのソース](https://cloud.google.com/blog/ja/products/ai-machine-learning/vertex-ai-studio-redesigned/)
  - ※この投稿は米国時間 2025 年 5 月 28 日に、Google Cloud blog に投稿されたものの抄訳です。
Google Cloud の Vertex AI プラットフォームを使用すると、最新の Google Gemini モデルや、Meta の Llama、Anthropic の C...
- [インシデント対応に AI を活用する: Personalized Service Health と Gemini Cloud Assist のインテグレーション](https://cloud.google.com/blog/ja/products/devops-sre/gemini-cloud-assist-integrated-with-personalized-service-health/)
  - ※この投稿は米国時間 2025 年 5 月 29 日に、Google Cloud blog に投稿されたものの抄訳です。
クラウド インシデントが発生した場合、誰もがそのクラウド プロバイダからの迅速かつ明確なコミュニケーションを望み、その情報を効果的に活用したいと考えます。Google Cloud...
- [Google Distributed Cloud（GDC）と GDC エアギャップ アプライアンスが DoD 影響レベル 6（IL6）認定を取得](https://cloud.google.com/blog/ja/topics/public-sector/google-distributed-cloud-gdc-gdc-air-gapped-appliance-achieve-dod-impact-level-6-il6-authorization/)
  - ※この投稿は米国時間 2025 年 5 月 29 日に、Google Cloud blog に投稿されたものの抄訳です。このたび、Google Public Sector ビジネスの重要なマイルストーンとして、Google Distributed Cloud（GDC）と GDC エアギャップ アプラ...
- [Anthropic の Claude Opus 4 と Claude Sonnet 4 が Vertex AI に登場](https://cloud.google.com/blog/ja/products/ai-machine-learning/anthropics-claude-opus-4-and-claude-sonnet-4-on-vertex-ai/)
  - ※この投稿は米国時間 2025 年 5 月 23 日に、Google Cloud blog に投稿されたものの抄訳です。
このたび、Anthropic の最新世代 Claude モデルである Claude Opus 4 と Claude Sonnet 4 の追加により、Vertex AI Model...
- [EPAM と Cortex Framework を活用したアジャイルなメディア実験を通じて売上増加率を測定する Mars Wrigley の取り組み](https://cloud.google.com/blog/ja/products/data-analytics/how-mars-uses-media-experiments-to-measure-sales-lift-with-cortex/)
  - ※この投稿は米国時間 2025 年 4 月 25 日に、Google Cloud blog に投稿されたものの抄訳です。
日用消費財ブランドは、現在から将来にわたる売り上げの拡大を目指し、広告に多額の投資を行ってブランドへの好感度を高めています。多くの場合、展開中のキャンペーンは、特定のオーディエン...
- [M-Trends 2025: 最前線からデータ、分析情報、推奨事項をお届け](https://cloud.google.com/blog/ja/topics/threat-intelligence/m-trends-2025/)
  - ※この投稿は米国時間 2025 年 4 月 24 日に、Google Cloud blog に投稿されたものの抄訳です。
 
脅威アクターは、進化を続けるサイバー防御の状況に対応する 1 つの方法として、攻撃の高度化を図っています。この傾向は当社が関わる多くの案件で見られ、特に中国に関連するグループ...
- [Gemini Code Assist を利用して要件ドキュメントからアプリケーションのプロトタイプを作成](https://cloud.google.com/blog/ja/topics/developers-practitioners/from-requirements-to-prototype-with-gemini-code-assist/)
  - ※この投稿は米国時間 2025 年 4 月 24 日に、Google Cloud blog に投稿されたものの抄訳です。
次のプロジェクトを開始する際、多くの場合は詳細な製品要件を記述したドキュメントがすでにあります。このような場合に、ドキュメント全体を読み、手動でコーディングを開始（またはテストケ...
- [データベース向け MCP ツールボックス: AI エージェントによる企業データへのアクセスを簡素化](https://cloud.google.com/blog/ja/products/ai-machine-learning/mcp-toolbox-for-databases-now-supports-model-context-protocol/)
  - ※この投稿は米国時間 2025 年 4 月 23 日に、Google Cloud blog に投稿されたものの抄訳です。
Google Cloud Next 25 では、企業が Vertex AI と Google Cloud データベースを使用してマルチエージェント エコシステムを構築するための優...
- [Google Cloud データベースと LangChain のインテグレーションが Go、Java、JavaScript に対応](https://cloud.google.com/blog/ja/products/databases/google-cloud-database-and-langchain-integrations-support-go-java-and-javascript/)
  - ※この投稿は米国時間 2025 年 4 月 23 日に、Google Cloud blog に投稿されたものの抄訳です。
昨年、Google Cloud と LangChain のインテグレーションが発表され、生成 AI デベロッパーが  LangChain Python パッケージ スイートにアク...
...
- [国会議員の過去発言をAIで分析し、政治的立場をまとめたサイト「KOKKAI DOC」をトロント大が発表（生成AIクローズアップ）](https://www.techno-edge.net/article/2025/05/19/4367.html)
...
- [Eインクっぽさ満載「NXTPAPER 11 Plus」実機レビュー。“積ん読”消化に最適なTCLの変態AIタブレット](https://www.techno-edge.net/article/2025/05/18/4366.html)
  - TCLのタブレット、NXTPAPER 11 PlusがGREEN FUNDINGでクラファン開始となりました。NXTPAPERといえば、ハカセだけ大騒ぎしていた気がしますが、まさか日本上陸の日がやって来るとは……。...
- [検索しないAI検索エンジン「ZeroSearch」、人間作成データ不要のセルフプレイAI「Absolute Zero」など生成AI技術5つを解説（生成AIウィークリー）](https://www.techno-edge.net/article/2025/05/18/4365.html)
  - この1週間の気になる生成AI技術・研究をいくつかピックアップして解説する「生成AIウィークリー」（第95回）では、“検索しない”AI検索エンジン「ZeroSearch」や、AI自身が学習効率の良いタスクを生成し自分で解くことで学習する外部データ不要のAIシステム「Absolute Zero」を取り上...
- [生成AIグラビアをグラビアカメラマンが作るとどうなる？第48回：リファレンス画像を使うComfyUI Workflowいろいろ（西川和久）](https://www.techno-edge.net/article/2025/05/16/4363.html)
  - リファレンス画像を使用するComfyUI Workflowとは！？...
- [AI活用ゲーム開発ハッカソン、賞金100万円を獲得した作品は？QwenのAlibaba Cloud主催『Tokyo Game Jam』イベントリポート](https://www.techno-edge.net/article/2025/05/14/4358.html)
